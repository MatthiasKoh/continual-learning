...
def get_dataset(name, type='train', download=True, capacity=None, permutation=None, dir='./datasets',
    ...
    # load data-set
    if name == "animalpart":
        dataset = torchvision.datasets.ImageFolder("/content/drive/MyDrive/Colab Notebooks/ASTAR Tutorial 2022/Task312July/animalpart/",transform=dataset_transform, target_transform=target_transform)
